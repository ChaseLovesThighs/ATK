...
function ATK:CreateATK(ATKName)
	ATKName = ATKName or "ATK"
	...
	ScreenGui.Parent = (gethui and gethui()) or (get_hidden_gui and get_hidden_gui()) or game:GetService("CoreGui")
	...
	closeLib.MouseButton1Click:Connect(function()
		...
		if isClosed then
			...
			TweenService:Create(closeLib, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
				Rotation = 360
			}):Play()
			MainWhiteFrame:TweenSize(UDim2.new(0, 424, 0, 58), "In", "Linear", 0.12)
			TweenService:Create(MainWhiteFrame_2, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
				BackgroundTransparency = 1
			}):Play()
			TweenService:Create(MainWhiteFrame, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
				BackgroundTransparency = 1
			}):Play()
		else
			closeLib.Image = "rbxassetid://4988112250"
    ...
    function SectionHandler:CreateSection(secName)
		...
		function ElementHandler:Dropdown(dInfo, list, callback)
			...
			ImageButton.MouseButton1Click:Connect(function()
				if isDropped then
					isDropped = false
					dropDownFrame:TweenSize(UDim2.new(0, 394, 0, 42), "In", "Quint", 0.1)
					TweenService:Create(ImageButton, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
						Rotation = 0
					}):Play()
					task.wait(0.1)
					UpdateSize()
					...
					isDropped = true
					dropDownFrame:TweenSize(UDim2.new(0, 394, 0, DropYSize), "In", "Quint", 0.1)
					TweenService:Create(ImageButton, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
						Rotation = 180
					}):Play()
					task.wait(0.1)
